...
pub fn create_table(table: TableDefinition, catalog: &mut Catalog) -> anyhow::Result<()> {
...
fn create_table_on_disk(table: &TableDefinition, catalog: &Catalog) -> anyhow::Result<()> {
